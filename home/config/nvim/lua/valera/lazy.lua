...
return require('lazy').setup({
	...
	{                            -- Math
		dir = '/home/v/g/lean.nvim', --TODO: switch to 'Julian/lean.nvim', once [my pr](https://github.com/Julian/lean.nvim/pull/485) is accepted
	...
	{ import = "valera.plugins.render-markdown" },
