require('crates').setup {
	...
	popup = {
		...
		text = {
			...
			build_dependencies_title = "B Build dependencies",
	...
	completion = {
		...
		--DEPRECATE: commented out to prevent a warning; remove once certain that this did not cut any important functionality
		--cmp = {
		--	--enabled = false,
