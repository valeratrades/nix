...
# brings it up.
#
# Source of truth is sops (secrets/users/v/default.json: telegram_token_main,
...
TOKEN="$(sops --decrypt --extract '["telegram_token_main"]' "$SECRETS")"
CHAT="$(sops --decrypt --extract '["telegram_alerts_channel"]' "$SECRETS")"
